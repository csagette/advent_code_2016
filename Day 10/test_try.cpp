...
int main() {
    ...
    if(file) {    
        ...
        // all good jusqu'ici
        // fin boucle while
        // lecture multiple des conditions pour réaliser les transferts de microships
        while(to_review.size() > 0) {
            std::vector<int> temp;
            ...
            for(int i : to_review) {
                ...
                if(dico_bot.find(who_donate)->second[0] == 2 && dico_bot.find(who_donate)->second[1] == 5) {
